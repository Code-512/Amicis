      ...
      <div className="container marketing">
        <div className="row">
          <div className="col-lg-4">
            {/* Begin Julies info */}
            <img
              src="https://scontent-dfw5-1.xx.fbcdn.net/v/t1.0-9/11062735_1079024765442213_3180324841654794004_n.jpg?_nc_cat=103&_nc_ht=scontent-dfw5-1.xx&oh=1efebd0586f2fbc7bba7c3e4e2988784&oe=5CFA29CB"
              width="140"
              height="140"
              background="#777"
              color="#777"
            ...
            <p>
              An exciting, diverse, and winding road has led her to be the Team
              Lead and a Full-Stack web developer. She has worked as a National
              Park Ranger/firefighter, math teacher, event director, and
              operations manager. She is also an avid reader and math geek.{" "}
            </p>
          ...
          <div className="col-lg-4">
            <img
              src="https://media.licdn.com/dms/image/C4E03AQHE2s_3WsOIcA/profile-displayphoto-shrink_800_800/0?e=1554336000&v=beta&t=CUAujFFszwfftjb-0DhALjZBPk0atjy7wmQ_s1feK5Y"
              width="140"
              height="140"
              background="#777"
              color="#777"
            ...
            <p>
              Boni the Bull is Creative Director. He has a knack for creating
              simple, intuitive solutions for each project. With almost a decade
              of design, The Bull loves to help our partners see their creative
              vision come to life.
            </p>
            <br />
            <div>
          ...
          <div className="col-lg-4">
            <img
              src="https://media.licdn.com/dms/image/C5603AQFf_RYr5PUATQ/profile-displayphoto-shrink_200_200/0?e=1554336000&v=beta&t=yEieGqmKi66WRN3175R57hRN6710pDk_vgo6NwNXDZQ"
              width="140"
              height="140"
              background="#777"
              color="#777"
            ...
            <h4>Full-Stack Developer</h4>
            <p>
              JareBare is our founder and just getting started as a full-stack
              developer. He enjoys solving problems from all angles,
              collaborating in a community-minded area for a more lucrative
              strategy. When he's not practicing his new talents, you can find
              him...{" "}
            </p>
            <div>
